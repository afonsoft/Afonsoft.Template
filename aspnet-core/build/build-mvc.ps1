...
$webMvcFolder = Join-Path $slnFolder "src/Afonsoft.NewTemplate.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Afonsoft.NewTemplate.Web.Public"
...
dotnet restore Afonsoft.NewTemplate.Web.sln
