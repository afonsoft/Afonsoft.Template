                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            visible: function () {
                                return _dynamicEntityPropertyManager.canShow('Afonsoft.NewTemplate.Authorization.Users.User');
                            },
                            action: function (data) {
                                _dynamicEntityPropertyManager.modal.open({
                                    entityFullName: 'Afonsoft.NewTemplate.Authorization.Users.User',
