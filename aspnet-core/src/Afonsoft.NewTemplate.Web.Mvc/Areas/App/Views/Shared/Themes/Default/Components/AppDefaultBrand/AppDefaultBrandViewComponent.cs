...
namespace Afonsoft.NewTemplate.Web.Areas.App.Views.Shared.Themes.Default.Components.AppDefaultBrand
{
    public class AppDefaultBrandViewComponent : NewTemplateViewComponent
    {
