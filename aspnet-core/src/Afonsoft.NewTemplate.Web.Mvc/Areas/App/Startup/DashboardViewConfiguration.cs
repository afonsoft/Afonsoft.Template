...
using Afonsoft.NewTemplate.Web.DashboardCustomization;
...
namespace Afonsoft.NewTemplate.Web.Areas.App.Startup
{
    public class DashboardViewConfiguration
    {
        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetFilterViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Filters.FilterDateRangePicker,
                new WidgetFilterViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Tenant.TopStats,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Host.TopStats,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            WidgetViewDefinitions.Add(NewTemplateDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
                    NewTemplateDashboardCustomizationConsts.Widgets.Host.RecentTenants,
