...
using Afonsoft.NewTemplate.Web.Areas.App.Models.Languages;
...
namespace Afonsoft.NewTemplate.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : NewTemplateControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = NewTemplateConsts.LocalizationSourceName;
            }
