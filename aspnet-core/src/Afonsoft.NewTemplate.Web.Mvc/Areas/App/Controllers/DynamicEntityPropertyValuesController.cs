...
using Afonsoft.NewTemplate.Web.Areas.App.Models.DynamicEntityPropertyValues;
...
namespace Afonsoft.NewTemplate.Web.Areas.App.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : NewTemplateControllerBase
    {
