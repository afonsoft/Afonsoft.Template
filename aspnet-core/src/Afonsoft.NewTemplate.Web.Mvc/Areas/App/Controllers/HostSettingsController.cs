...
using Afonsoft.NewTemplate.Configuration.Host;
using Afonsoft.NewTemplate.Editions;
using Afonsoft.NewTemplate.Timing;
using Afonsoft.NewTemplate.Timing.Dto;
using Afonsoft.NewTemplate.Web.Areas.App.Models.HostSettings;
...
namespace Afonsoft.NewTemplate.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : NewTemplateControllerBase
    {
