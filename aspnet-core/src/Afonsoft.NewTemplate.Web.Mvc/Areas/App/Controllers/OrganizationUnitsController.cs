...
using Afonsoft.NewTemplate.Web.Areas.App.Models.Common.Modals;
using Afonsoft.NewTemplate.Web.Areas.App.Models.OrganizationUnits;
...
namespace Afonsoft.NewTemplate.Web.Areas.App.Controllers
{
    ...
    public class OrganizationUnitsController : NewTemplateControllerBase
    {
