...
using Afonsoft.NewTemplate.Web.Areas.App.Models.Roles;
using Afonsoft.NewTemplate.Web.Areas.App.Models.Users;
...
namespace Afonsoft.NewTemplate.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class UsersController : NewTemplateControllerBase
    {
