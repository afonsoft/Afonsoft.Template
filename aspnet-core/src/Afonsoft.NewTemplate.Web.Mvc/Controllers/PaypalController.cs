...
using Afonsoft.NewTemplate.MultiTenancy.Payments.Paypal;
using Afonsoft.NewTemplate.MultiTenancy.Payments.PayPal;
using Afonsoft.NewTemplate.Web.Models.Paypal;

namespace Afonsoft.NewTemplate.Web.Controllers
{
    public class PayPalController : NewTemplateControllerBase
    {
