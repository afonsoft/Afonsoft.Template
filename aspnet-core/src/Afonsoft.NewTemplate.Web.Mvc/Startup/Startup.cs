...
using Afonsoft.NewTemplate.Web.Chat.SignalR;
using Afonsoft.NewTemplate.Web.Resources;
using Afonsoft.NewTemplate.Web.IdentityServer;
using Afonsoft.NewTemplate.Web.Swagger;
using Stripe;
...
using Afonsoft.NewTemplate.Web.HealthCheck;
using Owl.reCAPTCHA;
...
namespace Afonsoft.NewTemplate.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<NewTemplateWebMvcModule>(options =>
            {
