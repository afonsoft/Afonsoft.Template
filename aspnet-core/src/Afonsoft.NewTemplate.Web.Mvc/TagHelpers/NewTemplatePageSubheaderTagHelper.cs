...
namespace Afonsoft.NewTemplate.Web.TagHelpers
{
    ...
    public class NewTemplatePageSubheaderTagHelper : TagHelper
    {
        ...
        public NewTemplatePageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
