...
namespace Afonsoft.NewTemplate.Web.Authentication.JwtBearer
{
    public class NewTemplateJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public NewTemplateJwtSecurityTokenHandler()
        {
