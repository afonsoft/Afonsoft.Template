...
using Afonsoft.NewTemplate.Web.Authentication.TwoFactor;
using Afonsoft.NewTemplate.Web.Models.TokenAuth;
...
namespace Afonsoft.NewTemplate.Web.Controllers
{
    ...
    public class TokenAuthController : NewTemplateControllerBase
    {
