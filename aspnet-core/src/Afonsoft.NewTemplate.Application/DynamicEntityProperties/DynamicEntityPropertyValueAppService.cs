...
using Afonsoft.NewTemplate.DynamicEntityPropertyValues.Dto;
...
namespace Afonsoft.NewTemplate.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : NewTemplateAppServiceBase, IDynamicEntityPropertyValueAppService
    {
