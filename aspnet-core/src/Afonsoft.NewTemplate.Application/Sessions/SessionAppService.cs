...
{
    public class SessionAppService : NewTemplateAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = NewTemplateConsts.Currency,
                    CurrencySign = NewTemplateConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = NewTemplateConsts.AllowTenantsToChangeEmailSettings,
