...
namespace Afonsoft.NewTemplate.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : NewTemplateAppServiceBase, IUserDelegationAppService
    {
