...
using Afonsoft.NewTemplate.Authorization.Users.Profile.Cache;
...
using Afonsoft.NewTemplate.Gdpr;
...
{
    [AbpAuthorize]
    public class ProfileAppService : NewTemplateAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Afonsoft.NewTemplate",
