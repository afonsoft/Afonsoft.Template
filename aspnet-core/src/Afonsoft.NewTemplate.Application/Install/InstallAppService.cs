...
using Afonsoft.NewTemplate.Migrations.Seed.Host;
...
namespace Afonsoft.NewTemplate.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : NewTemplateAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<NewTemplateDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{NewTemplateConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{NewTemplateConsts.ConnectionStringName}", constring);
        }
