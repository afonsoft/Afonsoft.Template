...
using Afonsoft.NewTemplate.DemoUiComponents.Dto;

namespace Afonsoft.NewTemplate.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : NewTemplateAppServiceBase, IDemoUiComponentsAppService
    {
