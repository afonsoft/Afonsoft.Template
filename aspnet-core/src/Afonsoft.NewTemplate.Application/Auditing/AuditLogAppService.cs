...
using Afonsoft.NewTemplate.Auditing.Exporting;
...
using EntityHistoryHelper = Afonsoft.NewTemplate.EntityHistory.EntityHistoryHelper;

namespace Afonsoft.NewTemplate.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : NewTemplateAppServiceBase, IAuditLogAppService
    {
