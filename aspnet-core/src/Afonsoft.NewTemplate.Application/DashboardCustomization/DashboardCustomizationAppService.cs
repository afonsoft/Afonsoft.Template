...
namespace Afonsoft.NewTemplate.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : NewTemplateAppServiceBase, IDashboardCustomizationAppService
    {
