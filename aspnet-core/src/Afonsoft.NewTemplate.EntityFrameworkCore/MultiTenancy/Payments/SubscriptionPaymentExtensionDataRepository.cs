...
using Afonsoft.NewTemplate.EntityFrameworkCore.Repositories;

namespace Afonsoft.NewTemplate.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : NewTemplateRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<NewTemplateDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
