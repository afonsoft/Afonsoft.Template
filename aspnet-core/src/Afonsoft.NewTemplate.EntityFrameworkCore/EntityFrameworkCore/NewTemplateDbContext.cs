...
{
    public class NewTemplateDbContext : AbpZeroDbContext<Tenant, Role, User, NewTemplateDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public NewTemplateDbContext(DbContextOptions<NewTemplateDbContext> options)
            : base(options)
        {
