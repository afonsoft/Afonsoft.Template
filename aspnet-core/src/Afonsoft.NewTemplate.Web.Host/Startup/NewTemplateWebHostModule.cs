...
using Afonsoft.NewTemplate.Web.Startup.ExternalLoginInfoProviders;
...
namespace Afonsoft.NewTemplate.Web.Startup
{
    ...
    public class NewTemplateWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public NewTemplateWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(NewTemplateWebHostModule).GetAssembly());
        }
