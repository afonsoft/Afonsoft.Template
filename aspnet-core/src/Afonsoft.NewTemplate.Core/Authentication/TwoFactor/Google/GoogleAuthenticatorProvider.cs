...
namespace Afonsoft.NewTemplate.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : NewTemplateServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Afonsoft.NewTemplate", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
