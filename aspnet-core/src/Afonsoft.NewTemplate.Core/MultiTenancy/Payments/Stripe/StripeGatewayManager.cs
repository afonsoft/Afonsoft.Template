...
{
    public class StripeGatewayManager : NewTemplateServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "NewTemplate";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + NewTemplateConsts.Currency;
        }
