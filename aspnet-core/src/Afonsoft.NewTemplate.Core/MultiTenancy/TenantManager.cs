...
using Afonsoft.NewTemplate.MultiTenancy.Demo;
...
namespace Afonsoft.NewTemplate.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(NewTemplateConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(NewTemplateConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
