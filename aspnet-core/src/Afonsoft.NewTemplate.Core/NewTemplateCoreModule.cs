...
using Afonsoft.NewTemplate.Authorization.Ldap;
...
using Afonsoft.NewTemplate.DashboardCustomization.Definitions;
using Afonsoft.NewTemplate.Debugging;
using Afonsoft.NewTemplate.DynamicEntityProperties;
using Afonsoft.NewTemplate.Features;
using Afonsoft.NewTemplate.Friendships;
using Afonsoft.NewTemplate.Friendships.Cache;
using Afonsoft.NewTemplate.Localization;
using Afonsoft.NewTemplate.MultiTenancy;
using Afonsoft.NewTemplate.Net.Emailing;
using Afonsoft.NewTemplate.Notifications;
using Afonsoft.NewTemplate.WebHooks;
using Newtonsoft.Json;

namespace Afonsoft.NewTemplate
{
    [DependsOn(
        typeof(NewTemplateCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class NewTemplateCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            NewTemplateLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = NewTemplateConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, NewTemplateMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<NewTemplateSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(NewTemplateCoreModule).GetAssembly());
        }
