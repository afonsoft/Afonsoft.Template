...
using MvvmHelpers;
using Afonsoft.NewTemplate.Common;
using Afonsoft.NewTemplate.Core.Exception;
...
using Afonsoft.NewTemplate.Models.Tenants;
...
using Xamarin.Forms;
using Afonsoft.NewTemplate.Validations;
