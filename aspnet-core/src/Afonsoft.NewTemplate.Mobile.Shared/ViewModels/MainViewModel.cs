...
using Afonsoft.NewTemplate.Services.Navigation;
...
using Afonsoft.NewTemplate.ApiClient;
using Afonsoft.NewTemplate.Controls;
using Afonsoft.NewTemplate.Dto;
using Afonsoft.NewTemplate.Extensions;
using Afonsoft.NewTemplate.Localization;
using Afonsoft.NewTemplate.UI;
using Afonsoft.NewTemplate.UI.Assets;
using Afonsoft.NewTemplate.Views;
using DependencyResolver = Afonsoft.NewTemplate.Core.Dependency.DependencyResolver;
...
namespace Afonsoft.NewTemplate.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "NewTemplate";
