...
using Afonsoft.NewTemplate.MultiTenancy.HostDashboard;
...
namespace Afonsoft.NewTemplate.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(NewTemplateDbContext context, SubscriptionPayment subscriptionPayment)
        {
